...
export_climate_for_soilwat <- function(station_dat) {
  ...
  if(!dir.exists('data-raw/weather_export')){ dir.create('data-raw/weather_export')}
  ...
  for ( i in 1:length( year_list) ) {
    ...
    temp_fname <- file.path( 'data-raw', 'weather_export', paste0( 'weath.', temp_year) )
